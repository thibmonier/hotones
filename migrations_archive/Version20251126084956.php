 ...
 */
final class Version20251126084956 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Remove cjm and tjm columns from contributors table - financial data now sourced from EmploymentPeriods';
    }
