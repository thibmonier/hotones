 ...
 */
final class Version20260103222111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE companies CHANGE owner_id owner_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE companies CHANGE owner_id owner_id INT NOT NULL');
