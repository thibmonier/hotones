...
class SkillFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        $skills = [
            ...
            ['name' => 'JavaScript', 'category' => 'technique', 'description' => 'Langage de programmation orienté client et serveur'],
            ...
            ['name' => 'Node.js', 'category' => 'technique', 'description' => 'Environnement d\'exécution JavaScript côté serveur'],
            ['name' => 'Express.js', 'category' => 'technique', 'description' => 'Framework web minimaliste pour Node.js'],
            ['name' => 'NestJS', 'category' => 'technique', 'description' => 'Framework Node.js progressif pour applications serveur'],
            ...
            ['name' => 'Spring Boot', 'category' => 'technique', 'description' => 'Framework Java pour applications Spring'],
            ['name' => 'ASP.NET Core', 'category' => 'technique', 'description' => 'Framework .NET pour applications web'],
            ['name' => 'Ruby on Rails', 'category' => 'technique', 'description' => 'Framework web Ruby'],

            // Compétences techniques - Frameworks Frontend
            ['name' => 'React', 'category' => 'technique', 'description' => 'Bibliothèque JavaScript pour interfaces utilisateur'],
            ...
            ['name' => 'Next.js', 'category' => 'technique', 'description' => 'Framework React avec rendu côté serveur'],
            ['name' => 'Nuxt.js', 'category' => 'technique', 'description' => 'Framework Vue.js avec rendu côté serveur'],

            // Compétences techniques - Bases de données
            ['name' => 'MySQL', 'category' => 'technique', 'description' => 'Système de gestion de base de données relationnelle'],
            ['name' => 'PostgreSQL', 'category' => 'technique', 'description' => 'Base de données relationnelle avancée'],
            ['name' => 'MariaDB', 'category' => 'technique', 'description' => 'Fork de MySQL'],
            ['name' => 'MongoDB', 'category' => 'technique', 'description' => 'Base de données NoSQL orientée document'],
            ['name' => 'Redis', 'category' => 'technique', 'description' => 'Base de données clé-valeur en mémoire'],
            ['name' => 'Elasticsearch', 'category' => 'technique', 'description' => 'Moteur de recherche et d\'analyse'],
            ...
            ['name' => 'WebSockets', 'category' => 'technique', 'description' => 'Communication bidirectionnelle temps réel'],

            // Soft Skills
            ['name' => 'Communication', 'category' => 'soft_skill', 'description' => 'Capacité à communiquer efficacement'],
            ['name' => 'Travail en équipe', 'category' => 'soft_skill', 'description' => 'Collaboration avec les autres'],
            ['name' => 'Leadership', 'category' => 'soft_skill', 'description' => 'Capacité à diriger et motiver'],
            ['name' => 'Résolution de problèmes', 'category' => 'soft_skill', 'description' => 'Analyse et résolution de problèmes complexes'],
            ...
            ['name' => 'Prise de décision', 'category' => 'soft_skill', 'description' => 'Capacité à décider efficacement'],
            ['name' => 'Présentation', 'category' => 'soft_skill', 'description' => 'Capacité à présenter devant un public'],
