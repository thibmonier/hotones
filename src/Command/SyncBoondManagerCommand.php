...
HELP
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            if ($all) {
                return $this->syncAllCompanies($io, $startDate, $endDate, $async, $syncResources, $syncProjects, $testConnection);
            }
    ...
    private function syncAllCompanies(
        ...
        foreach ($settingsList as $settings) {
            ...
            if ($async) {
                $this->messageBus->dispatch(new SyncBoondManagerTimesMessage(
