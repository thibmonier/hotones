...
/**
 * Contributor identifier (UUID native or legacy:N int wrapper for Phase 2 ACL).
 *
...
final readonly class ContributorId
{
    ...
    private function __construct(
        ...
        if (!Uuid::isValid($value)) {
            throw new InvalidArgumentException(sprintf('Invalid ContributorId format: %s', $value));
        }
    }
    ...
    {
        if (!$this->isLegacy()) {
            throw new InvalidArgumentException('ContributorId is not a legacy int wrapper');
        }
