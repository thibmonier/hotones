 ...
 *
 *  HR / VACATION
 *    - VACATION_CANCELLED_BY_MANAGER : a manager cancelled a vacation that was already
 *      approved or pending (US-069 + TECH-DEBT-001), the contributor is notified.
 *
 * Adding a case: also add an arm to `getLabel()`, `getIcon()`, `getColor()`,
 * and update `tests/Unit/Enum/NotificationTypeTest.php` (`exposes_exactly_11_notification_types`).
 *
...
enum NotificationType: string
{
    ...
    case VACATION_CANCELLED_BY_MANAGER = 'vacation_cancelled_by_manager';
    ...
    public function getLabel(): string
    {
        return match ($this) {
            ...
            self::VACATION_CANCELLED_BY_MANAGER => 'Demande de conge annulee par le manager',
        };
    }
    ...
    public function getIcon(): string
    {
        return match ($this) {
            ...
            self::VACATION_CANCELLED_BY_MANAGER => 'fa-rotate-left',
        };
    }
    ...
    public function getColor(): string
    {
        return match ($this) {
            ...
            self::VACATION_CANCELLED_BY_MANAGER => 'warning',
        };
    }
}
