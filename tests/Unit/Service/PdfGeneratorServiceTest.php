...
class PdfGeneratorServiceTest extends TestCase
{
    ...
    {
        $this->twig->method('render')->willReturn('<html><body><h1>Test PDF</h1></body></html>');
    ...
    {
        $this->twig->method('render')->willReturn('<html><body>Content</body></html>');
    ...
    {
        $this->twig->method('render')->willReturn('<html><body>Test</body></html>');
    ...
    {
        $this->twig->method('render')->willReturn('<html><body>Landscape PDF</body></html>');
