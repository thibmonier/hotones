...
final class AuditContributorsCjmDailyHoursTest extends TestCase
{
    public function testCommandRegistersAuditDailyHoursOption(): void
    {
        ...
        static::assertTrue($configureMethod->isProtected());
        static::assertSame('configure', $configureMethod->getName());
    }
    ...
    public function testExecuteMethodHandlesAuditDailyHoursBranch(): void
    {
        ...
        static::assertTrue($reflection->hasMethod('executeDailyHoursAudit'));
        $method = $reflection->getMethod('executeDailyHoursAudit');
        static::assertTrue($method->isPrivate());
        static::assertCount(3, $method->getParameters());
    }
    ...
    public function testEnforceReadOnlyTransactionMethodExists(): void
    {
        ...
        static::assertTrue($reflection->hasMethod('enforceReadOnlyTransaction'));
    ...
    public function testCheckDailyHoursValidityBoundsAreReasonable(): void
    {
        ...
        static::assertSame(80.0, 80.0); // documentary assertion
        static::assertSame(100.0, 100.0);
    }
    ...
    public function testRenderDailyHoursIssuesTableIsPrivate(): void
    {
        ...
        static::assertTrue($reflection->hasMethod('renderDailyHoursIssuesTable'));
        static::assertTrue($reflection->getMethod('renderDailyHoursIssuesTable')->isPrivate());
    }
