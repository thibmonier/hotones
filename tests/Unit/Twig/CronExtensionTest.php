...
final class CronExtensionTest extends TestCase
{
    ...
    public static function provideHumanizeCases(): array
    {
        return [
            ...
            'weekdays step-range (fr)' => ['15 9-17/2 * * 1-5', 'fr', 'chaque lundi - vendredi toutes les 2 heures entre 09:00 et 17:00 à la minute 15'],
    ...
    public function testHumanizeCron(string $expr, string $locale, string $expectedStartsWith): void
    {
        ...
        $this->assertStringStartsWith($expectedStartsWith, $actual, sprintf('Humanized cron for "%s" (%s) should start with "%s"; got "%s"', $expr, $locale, $expectedStartsWith, $actual));
    }
